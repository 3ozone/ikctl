...
1. Antes de empezar lee FIRST_AGENT.md
...
| `docs/architecture.md`       | Clean Architecture: capas, regla de dependencia, flujos de datos, qué NO hacer | Antes de implementar |
| `docs/tech_stack.md`         | Herramientas elegidas y justificación (Python, FastAPI, MariaDB, structlog…) | Antes de implementar o añadir una dependencia |
| `docs/conventions.md`        | Reglas de estilo, nombres, tests, logging (Python)                          | Antes de escribir código |
...
| `app/`                       | Código de la aplicación (`app/v1/{module}/`)                               | Para implementar |
